...
var suo = {
  ...
  initUi1: function (type) {
    ...
    for (var i = 0; i < uitype.length; i++) {
      ...
      var dompart = suo.domCreate2("div", {
        setName: ["className"],
        setValue: ["uibox"]
      }, null, null, {
        setName: ["confobj"],
  ...
  domUi: function (obj, conf) {
    ...
    var domlabel = suo.domCreate2("label", {
      setName: ["className"],
      setValue: ["uilabel"]
    }, null, null, null, suo.getI18n("ui_" + obj.confele));
    var dommain = suo.domCreate2(obj.dom, {
      setName: ["type", "className"],
      setValue: [obj.type, "change"]
    }, null, null, {
      setName: ["confele"],
      setValue: [obj.confele]
    });
    ...
    if (obj.type == "range") {
      ...
      for (var i = 0; i < obj.select.length; i++) {
        dommain.appendChild(suo.domCreate2("option", {
          setName: ["value"],
          setValue: [obj.select[i]]
        }, null, null, null, suo.getI18n( /*"s_o_"+*/ obj.select[i])));
      }
      dom.appendChild(domlabel);
      dom.appendChild(dommain);
    }
  ...
  initMenu: function () {
    ...
    for (var i = 0; i < menuModel.main.length; i++) {
      ...
      for (var j = 0; j < menuModel[menuModel.main[i]].length; j++) {
        ...
        var menuLI = suo.domCreate2("li", {
          setName: ["className"],
          setValue: ["menuli"]
        }, null, null, menuData, suo.getI18n(menuModel[menuModel.main[i]][j]));
  ...
  createMoreSelect: function (type, value, confOBJ) {
    ...
    if (["n_txtengine", "n_imgengine", "n_script"].contains(type)) {
      ...
      for (i = 0; i < (type == "script" ? config.general.script[type].length : config.general.engine[type].length); i++) {
        domSelect.appendChild(suo.domCreate2("option", {
          setName: ["value"],
          setValue: ["" + i]
        }, null, null, null, type == "script" ? config.general.script[type][i]["name"] : config.general.engine[type][i]["name"]));
        if (i == value) {
          index = i;
        }
      }
      domSelect.appendChild(suo.domCreate2("option", {
        setName: ["value"],
        setValue: ["add_from_select"]
      }, null, null, null, "Add new ..."));
    } else {
      let _obj = {};
      ...
      for (i = 0; i < _obj.length; i++) {
        domSelect.appendChild(suo.domCreate2("option", {
          setName: ["value"],
          setValue: [_obj[i]]
        }, null, null, null, type == "n_voicename" ? _obj[i] : suo.getI18n(_obj[i])));
        if (type == "script") {
          if (i == value) {
            index = i
          }
  ...
  createMoreText: function (_conf) {
    ...
    var labelText = suo.domCreate2("label", {
        setName: ["className"],
        setValue: ["boxlabel"]
      }, null, null, null, suo.getI18n(conf.type)),
  ...
  createMoreCheck: function (_conf) {
    ...
    var dom = suo.domCreate2("div", {
      ...
      labelCheck = suo.domCreate2("label", {
        setName: ["id", "for"],
        setValue: [conf.type, conf.type]
      }, null, null, null, suo.getI18n(conf.type)),
    ...
    if (conf.typeCheck) {
      ...
      var _checkList = suo.domCreate2("div", {
        setName: ["className"],
        setValue: ["box_checklist"]
      }, null, conf.value ? "display:block;" : "display:none;");
      ...
      switch (conf.typeCheck) {
        ...
        case "text":
          var domText = suo.domCreate2("input", {
            setName: ["name", "type", "value", "className"],
            setValue: [conf.type, "text", conf.valueOption == undefined ? actionOptions.checks[conf.type].options.valueOption : conf.valueOption, "box_checktext"]
          });
        ...
        case "select":
          ...
          for (i = 0; i < conf.options.settings.length; i++) {
            domSelect.appendChild(suo.domCreate2("option", {
              setName: ["value"],
              setValue: [conf.options.settings[i]]
            }, null, null, null, suo.getI18n(conf.options.settings[i])));
          }
        ...
        case "range":
          ...
          var domRange = suo.domCreate2("input", {
              setName: ["className", "name", "type", "min", "max", "step", "value"],
              setValue: ["change box_range", conf.type, "range", conf.options.settings[0], conf.options.settings[1], conf.options.settings[2], conf.valueOption == undefined ? conf.options.valueOption : conf.valueOption]
            }, null, null, {
              setName: ["typechange"],
              setValue: ["actionedit"]
            }),
            domText = suo.domCreate2("span", {
              setName: ["className"],
              setValue: ["box_rangevalue"]
            }, null, null, null, domRange.value);
          domRangeBox.appendChild(domRange);
          domRangeBox.appendChild(domText);

          if (conf.options.settings[3]) {
            var domUnit = suo.domCreate2("span", {
              setName: ["className"],
              setValue: ["box_rangeunit"]
            }, null, null, null, " ( " + conf.options.settings[3] + " ) ");
          ...
          for (var i = 0; i < conf.options.settings.length; i++) {
            var _dom = suo.domCreate2("div", null, null, "clear:both;"),
              _option = suo.domCreate2("input", {
                ...
                setValue: ["box_radiooption_" + i + _time, "box_radiooption", "radio", conf.typeCheck, conf.options.settings[i].name]
              }),
              _label = suo.domCreate2("label", {
                setName: ["className", "for"],
                setValue: ["box_radiooptionlabel", "box_radiooption_" + i + _time]
              }, null, null, null, suo.getI18n(conf.options.settings[i].name));
            ...
            switch (conf.options.settings[i].typeSetting) {
              case "text":
                var _text = suo.domCreate2("input", {
                  ...
                  setValue: ["box_radiooptiontext", "text", conf.valueOption == conf.options.settings[i].name ? conf.valueSetting : conf.options.settings[i].valueSetting]
                });
              ...
              case "range":
                var _div = suo.domCreate2("div", {
                  ...
                  _range = suo.domCreate2("input", {
                    setName: ["className", "type", "min", "max", "step", "value"],
                    setValue: ["change box_radiooptionrange", "range", conf.options.settings[i].moreSetting[0], conf.options.settings[i].moreSetting[1], conf.options.settings[i].moreSetting[2], conf.valueOption == conf.options.settings[i].name ? conf.valueSetting : conf.options.settings[i].valueSetting]
                  }, null, null, {
                    setName: ["typechange"],
                    setValue: ["actionedit"]
                  }),
                  _text = suo.domCreate2("span", {
                    setName: ["className"],
                    setValue: ["box_radiooptionrangetext"]
                  }, null, null, null, _range.value),
                  _unit = suo.domCreate2("span", {
                    setName: ["className"],
                    setValue: ["box_radiooptionrangeunit"]
                  }, null, null, null, " ( " + conf.options.settings[i].moreSetting[3] + " ) ");
  ...
  createMoreRange: function (_conf) {
    ...
    var dom = suo.domCreate2("div", {
      ...
      labelRange = suo.domCreate2("label", {
        setName: ["className"],
        setValue: ["boxlabel"]
      }, null, null, null, suo.getI18n(conf.type));
    ...
    var _range = suo.domCreate2("input", {
      setName: ["className", "type", "name", "min", "max", "step", "value"],
      setValue: ["change box_range", "range", conf.type, arrayOptions[0], arrayOptions[1], arrayOptions[2], conf.value]
    }, null, null, {
      setName: ["typechange"],
      setValue: ["actionedit"]
    });
    ...
    var _text = suo.domCreate2("span", {
      setName: ["className"],
      setValue: ["box_rangevalue"]
    }, null, null, null, conf.value);
    dom.appendChild(_text);

    if (arrayOptions[3]) {
      _range.style.cssText += "width:83px;";
      var _unit = suo.domCreate2("span", {
        setName: ["className"],
        setValue: ["box_rangeunit"]
      }, null, null, null, " ( " + arrayOptions[3] + " ) ");
  ...
  createMoreRadio: function (_conf) {
    ...
    var dom = suo.domCreate2("div", {
      ...
      labelRadio = suo.domCreate2("span", {
        setName: ["className"],
        setValue: ["box_radiolabel"]
      }, null, null, null, suo.getI18n(conf.type)),
      domOption = suo.domCreate2("div", {
        setName: ["className"],
        setValue: ["box_radio"]
      }, null, null, {
        setName: ["confobj"],
    ...
    for (var i = 0; i < conf.options.settings.length; i++) {
      var _dom = suo.domCreate2("div"),
        _option = suo.domCreate2("input", {
          setName: ["id", "className", "type", "name", "value"],
          setValue: ["box_radiooption_" + i + _time, "box_radiooption", "radio", conf.type, conf.options.settings[i].name]
        }),
        _domLabel = suo.domCreate2("label", {
          setName: ["className", "for"],
          setValue: ["box_radiooptionlabel", "box_radiooption_" + i + _time]
        }, null, null, null, suo.getI18n(conf.options.settings[i].name));
      ...
      switch (conf.options.settings[i].typeSetting) {
        case "text":
          var _text = suo.domCreate2("input", {
            setName: ["className", "type", "value"],
            setValue: ["box_radiooptiontext", "text", conf.value == conf.options.settings[i].name ? conf.valueSetting : conf.options.settings[i].valueSetting]
          });
          _radioList.appendChild(_text);
          break;
        case "select":
        ...
        case "range":
          ...
          var _range = suo.domCreate2("input", {
            setName: ["className", "type", "min", "max", "step", "value"],
            setValue: ["change box_radiooptionrange", "range", conf.options.settings[i].moreSetting[0], conf.options.settings[i].moreSetting[1], conf.options.settings[i].moreSetting[2], conf.value == conf.options.settings[i].name ? conf.valueSetting : conf.options.settings[i].valueSetting]
          }, null, null, {
            setName: ["typechange"],
            setValue: ["actionedit"]
          });
  ...
  set: {
    set_11: function () {
      ...
      for (var i = 1; i < menuModel.fn.length; i++) {
        var check = suo.domCreate2("input", {
          setName: ["type", "className"],
      ...
      domOBJ.appendChild(suo.domCreate2("div", {
        setName: ["className"],
        setValue: ["setdes"]
      }, null, null, null, suo.getI18n("des_fnswitch")));
    },
    set_10: function () {
      var domSet = suo.domCreate2("div", {
        setName: ["className"],
        setValue: ["set set-10"]
      }, "", "", {
        setName: ["conf0", "conf1"],
      ...
      var setname = suo.domCreate2("div", {
        setName: ["className"],
        setValue: ["setname"]
      }, null, null, null, suo.getI18n("settings"));
  ...
  initValue: function (delayDom, delay) {
    ...
    for (var i = 0; i < doms.length; i++) {
      ...
      if (doms[i].tagName.toLowerCase() == "input" && doms[i].type == "checkbox") {
        ...
        // skip text node
        if (doms[i].nextSibling.nodeType == 3) {
          continue;
        }

        // console.log("nextSibling", doms[i].nodeType);

        doms[i].nextSibling.setAttribute("for", doms[i].id);
        // console.log(doms[i].nextSibling, doms[i].id);
  ...
  initPer: function () {
    ...
    var theFunction = function (pers) {
      ...
      for (var i = thepers.length - 1; i > -1; i--) {
        ...
        var liName = suo.domCreate2("span", {
          setName: ["className"],
          setValue: ["item_name"]
        }, "", "", "", thepers[i]);
        var liDel = suo.domCreate2("span", {
          setName: ["className"],
          setValue: ["item_del"]
        }, null, null, null, "x");
  ...
  initListItem: function (type) {
    ...
    if (type == "rges") {
      ...
      var liName = suo.domCreate2("span", {
        setName: ["className"],
        setValue: ["item_name item_edit edit_rges"]
      }, null, "width:160px;", {
        setName: ["confid", "actiontype"],
        setValue: [0, "rges"]
      }, (confOBJ[0].mydes && confOBJ[0].mydes.type && confOBJ[0].mydes.value) ? confOBJ[0].mydes.value : suo.getI18n(confOBJ[0].name));
      liOBJ.appendChild(liName);
      _doms[0].textContent = "";
      ...
      var liName = suo.domCreate2("span", {
        ...
        setName: ["confid", "actiontype"],
        setValue: [1, "rges"]
      }, (confOBJ[1].mydes && confOBJ[1].mydes.type && confOBJ[1].mydes.value) ? confOBJ[1].mydes.value : suo.getI18n(confOBJ[1].name));
      liOBJ.appendChild(liName);
      _doms[1].textContent = "";
    ...
    if (type == "wges") {
      ...
      for (var i = 0; i < _doms.length; i++) {
        ...
        var _liName = suo.domCreate2("span", {
          setName: ["className"],
    ...
    if (type == "ksa") {
      for (var i = 0; i < confOBJ.length; i++) {
        ...
        var _domCode = suo.domCreate2("span", {
          setName: ["className"],
    ...
    for (var i = 0; i < confOBJ.length; i++) {
      ...
      var liName = suo.domCreate2("span", {
        ...
        setName: ["confid", "actiontype"],
        setValue: [i, actionType ? actionType : type]
      }, ("txtengine imgengine script".indexOf(type) != -1) ? confOBJ[i].name : ((confOBJ[i].mydes && confOBJ[i].mydes.type && confOBJ[i].mydes.value) ? confOBJ[i].mydes.value : suo.getI18n(confOBJ[i].name)));
      var liDel = suo.domCreate2("span", {
        setName: ["className", "title"],
        setValue: ["item_del", suo.getI18n("tip_del")]
      }, null, null, null, "x");
      ...
      if (confOBJ[i].note && confOBJ[i].note.value) {
        var _note = suo.domCreate2("span", {
          setName: ["className"],
          setValue: ["item_note item_edit"]
        }, null, null, null, confOBJ[i].note.value);
  ...
  itemEditDca: function (e) {
    return;
    if (!editMode || e.target.classList.contains("box_text") || e.target.classList.contains("box_note") || e.target.classList.contains("box_destext")) {
      return;
    }
    e.preventDefault();
    var dombox = document.querySelector("smartkey.sk_apps_edit"),
      domkeybox = dombox.querySelector(".box_keyvalue");
    if (!sdo.cons.editedConf.conf.code) {
  ...
  itemEditKsa: function (e, editType) {
    ...
    let domTab = suo.domCreate2("div", {
      setName: ["className"],
      setValue: ["box_tab"]
    });
    domTab.appendChild(suo.domCreate2("span", {
      setName: ["className"],
    ...
    let domTabbox = suo.domCreate2("div", {
      setName: ["className"],
      setValue: ["box_tabbox"]
    });
    let domTabListKeys = suo.domCreate2("div", {
      setName: ["className"],
    ...
    let domTabListAction = suo.domCreate2("div", {
      setName: ["className"],
      setValue: ["box_tablist box_tablistaction"]
    }, null, null, {
      setName: ["tab"],
      setValue: ["action"]
    });
    let domTabListMore = suo.domCreate2("div", {
      setName: ["className"],
      setValue: ["box_tablist box_tablistmore"]
    }, null, null, {
      setName: ["tab"],
      setValue: ["more"]
    });
  ...
  itemEdit: function (confobj, confid, type, direct, actiontype) {
    ...
    if (type == "edit" && (["mges", "tdrg", "ldrg", "idrg", "pop", "ctm", "txtengine", "imgengine", "script", "touch"].contains(actiontype))) {
      btnArray = btnArrayDel
    }
    var titleOBJ = {
      newaction: suo.getI18n("title_newaction"),
    ...
    if (["txtengine", "imgengine", "script"].contains(actionType)) {
      console.log("engines")
      //name
      domContent.appendChild(suo.domCreate2("label", {
        setName: ["className"],
        setValue: ["box-label"]
      }, null, null, null, suo.getI18n("con_name")));
      domContent.appendChild(suo.domCreate2("input", {
        setName: ["className", "type", "value"],
      ...
      domContent.appendChild(suo.domCreate2("label", {
        setName: ["className"],
        setValue: ["box-label"]
      }, null, null, null, suo.getI18n("n_content")));
      domContent.appendChild(suo.domCreate2("textarea", {
        setName: ["className", "type", "value"],
  ...
  initPos: function (dom) {
    ...
    var boxBGOBJ = document.documentElement.appendChild(suo.domCreate2("div", {
      setName: ["className"],
      setValue: ["box_bg"]
    }));
    window.setTimeout(function () {
  ...
  itemKey: function (confOBJ) {
    ...
    let dom = suo.domCreate2("div", {
      ...
      _resetBtn = suo.domCreate2("input", {
        setName: ["className", "type", "value"],
    ...
    codebox = suo.domCreate2("input", {
      ...
      setValue: ["text", suo.ksa.keyFormat(suo.ksa.keyGet(confOBJ.codes)), "box_keyvalue", "", suo.getI18n("tip_enterkeys"), suo.getI18n("tip_enterkeys")]
    });
  ...
  itemNote: function (confOBJ, type) {
    ...
    let _span = suo.domCreate2("span", null, null, null, null, suo.getI18n("con_notename")),
      ...
      _textarea = suo.domCreate2("textarea", {
        setName: ["className"],
        setValue: ["box_notevalue"]
      }, null, null, null, notevalue),
      ...
      _label = suo.domCreate2("label", {
        setName: ["for"],
        setValue: ["box_note"]
      }, null, null, null, suo.getI18n("con_notechk"));
  ...
  itemAction: function (confOBJ, actionType) {
    ...
    var domSelect = suo.domCreate2("select", valueOBJ, null, null, {
      setName: ["actiontype"],
      setValue: [actionType]
    }); //edom,eele,einner,ecss,edata,etxt
    var flag = 0,
      index = 0;
    ...
    for (var i = 0; i < actions[actionType + "_group"].length; i++) {
      ...
      for (var j = 0; j < actions[actionType][i].length; j++) {
        var domOption = suo.domCreate2("option", {
          setName: ["value"],
          setValue: [actions[actionType][i][j]["name"]]
        }, null, null, null, suo.getI18n(actions[actionType][i][j]["name"]));
  ...
  itemOption: function (confOBJ, actionType) {
    ...
    if (conf.selects) {
      for (var i = 0; i < conf.selects.length; i++) {
        dom.appendChild(suo.domCreate2("label", {
          setName: ["className"],
          setValue: ["boxlabel"]
        }, null, null, null, suo.getI18n(conf.selects[i].type)));
  ...
  itemMore: function (confOBJ, actionType) {
    ...
    if (conf.selects) {
      for (var i = 0; i < conf.selects.length; i++) {
        domMore.appendChild(suo.domCreate2("label", {
          setName: ["className"],
          setValue: ["boxlabel"]
        }, null, null, null, suo.getI18n(conf.selects[i].type)));
  ...
  itemDes: function (confOBJ) {
    ...
    var spacelabel = suo.domCreate2("label", {
      setName: ["className"],
      setValue: ["boxlabel"]
    }, "");
    var spacelabel2 = suo.domCreate2("label", {
      setName: ["className"],
      setValue: ["boxlabel"]
    }, "");
    var checkbox = suo.domCreate2("input", {
        ...
        if (actions[actionType][i][ii].name == e.target.options[e.target.selectedIndex].value) {
          ...
          if (actions[actionType][i][ii].texts) {
            for (var j = 0; j < actions[actionType][i][ii].texts.length; j++) {
              ...
              theOBJ.texts.push({
                type: actions[actionType][i][ii].texts[j]
              })
            }
          }
          if (actions[actionType][i][ii].checks) {
            for (var j = 0; j < actions[actionType][i][ii].checks.length; j++) {
              ...
              theOBJ.checks.push({
                type: actions[actionType][i][ii].checks[j] /*,value:actionOptions.checks*/
              })
            }
          }
  ...
  getPermission: function (permission) {
    chrome.permissions.request({
      permissions: permission /*["contentSettings"]*/
    }, function (granted) {
      if (!granted) {
      }
    });
  ...
  menuBarCreate: function () {
    ...
    document.body.appendChild(suo.domCreate2("div", {
      setName: ["id"],
      setValue: ["menu_bg"]
  ...
  showBtnAdd: function (type, confobj, dom) {
    ...
    if (!dom.querySelector("#btn_add")) {
      dom.appendChild(suo.domCreate2("img", {
  ...
  itemAddBefore: function (e) {
    ...
    let testDom = suo.domCreate2("div", {
      setName: ["className"],
      setValue: ["testbox"]
    }, null, null, null, testdes);
    if (confArray[1] == "ldrg") {
      testDom.textContent = "";
      testDom.appendChild(suo.domCreate2("a", {
        setName: ["href"],
        setValue: ["###"]
      }, null, null, null, suo.getI18n("test_ldrg")));
    } else if (confArray[1] == "idrg") {
      testDom.appendChild(suo.domCreate2("img", {
        setName: ["src"],
        setValue: ["../icon.png"]
      }));
    }
  ...
  donateBox: {
    ...
    dom: function (items) {
      ...
      let initDom = function (itemOBJ, id) {
        console.log(itemOBJ);
        var _list = suo.domCreate2("li", {
          setName: ["className", "title"],
          setValue: ["donate_listli", itemOBJ.name]
        }, null, null, {
          setName: ["id"],
          setValue: [id]
        }, itemOBJ.name);
        domList.appendChild(_list);
        var _content = suo.domCreate2("div", {
          setName: ["className"],
          setValue: ["donate_contentlist"]
        }, null, null, {
          setName: ["id"],
          setValue: [id]
        });
        switch (itemOBJ.type) {
          case "cryptocurrency":
            ...
            var _ccdiv = suo.domCreate2("div", {
              setName: ["className"],
              setValue: ["donate_ccdiv"]
            });
            for (var i = 0; i < itemOBJ.data.length; i++) {
              var _cccontent = suo.domCreate2("div", {
                setName: ["className"],
                setValue: ["donate_cccontent"]
              }, null, null, {
                setName: ["id"],
                setValue: [i]
              });

              _cccontent.appendChild(suo.domCreate2("textarea", {
                setName: ["className", "readOnly"],
                setValue: ["donate_cctext", true]
              }, null, null, {
                setName: ["id"],
                setValue: [i]
              }, itemOBJ.data[i].address));
          ...
          case "link":
            ...
            break;
          case "linkimg":
            var _a = suo.domCreate2("a", {
              setName: ["href", "target"],
              setValue: [itemOBJ.url, "_blank"]
            });
            var _img = suo.domCreate2("img", {
              setName: ["src"],
              setValue: [itemOBJ.img]
            });
            _a.appendChild(_img);
