...
sue.apps.recentclosed = {
  ...
  initUI: function () {
    ...
    for (var i = 0; i < this.tabs.length; i++) {
      ...
      var _li = sue.apps.domCreate("li", {setName: ["className"], setValue: ["su_recentclosed_li"]}, null, null, {
        setName: ["id"],
        setValue: [rctype.sessionId]
      }, (!this.tabs[i].window ? this.tabs[i].tab.title : this.tabs[i].window.tabs.length + " " + sue.apps.i18n("app_recentclosed_tabs")));
      var rc_title;
