...
sue.apps.homepage = {
  ...
  initUI: function () {
    ...
    let _listBox = sue.apps.domCreate("div", {
      setName: ["className"],
      setValue: ["su_homepage_listbox"]
    });
    dom.appendChild(_listBox);
    let _listItemBox = sue.apps.domCreate("div", {
      setName: ["className"],
  ...
  listInit: function (e) {
    ...
    for (var i = 0; i < _groups.length; i++) {
      ...
      var _li = sue.apps.domCreate("li", {
        setName: ["className"],
        setValue: ["su_homepage_listli"]
      }, null, null, {
        setName: ["id"],
        setValue: [i]
      });
      var _div = sue.apps.domCreate("div", {
        setName: ["className"],
  ...
  listInitEditmode: function (e) {
    ...
    let _domAddbtn = _domList.querySelector(".su_homepage_listaddbtn");
    if (sue.apps.homepage.cons.editMode) {
      if (!_domAddbtn) {
        let _listAddBtn = sue.apps.domCreate("div", {
          setName: ["className"],
          setValue: ["su_homepage_listaddbtn"]
        }, null, "background:url(" + chrome.runtime.getURL("image/add.svg") + ") no-repeat 2px 5px #e7e9fd;", null, sue.apps.i18n("homepage_newgroup"));
    ...
    let _listDivs = sue.apps.getAPPboxEle(e).querySelectorAll(".su_homepage_list");
    if (sue.apps.homepage.cons.editMode) {
      for (var i = 1; i < _listDivs.length; i++) {
        var _spanDel = sue.apps.domCreate("span", {
    ...
    if (sue.apps.homepage.cons.editMode) {
      sue.apps.homepage.cons.sortDomList = Sortable.create(sue.apps.getAPPboxEle(e).querySelector(".su_homepage_listbox ul"), {
        animation: 200,
        easing: "ease-in-out",
        ghostClass: "su_sortable_list",
        chosenClass: "su_sortable_list",
        onMove: function ( /**Event*/ evt, /**Event*/ originalEvent) {
          if (evt.dragged && evt.dragged.dataset && evt.dragged.dataset && evt.dragged.dataset.id == "0") {
            return false;
          }
        },
        onEnd: function (evt) {
          ...
          let arr = sue.apps.homepage.config.sitegroup;
          ...
          // reset sites
          let arrSites = sue.apps.homepage.config.sites;
          for (var ii in arr) {
  ...
  listNew: function (e) {
    ...
    let boxMain = sue.apps.domCreate("div", {
        setName: ["className"],
        setValue: ["su_homepage_addboxmain"]
      }),
      boxTitleLabel = sue.apps.domCreate("label", {
        setName: ["className"],
        setValue: ["su_homepage_addboxlabel"]
      }, null, null, null, sue.apps.i18n("homepage_grouptitle")),
    ...
    let boxBtn = sue.apps.domCreate("div", {
        setName: ["className"],
        setValue: ["su_homepage_addboxbtn"]
      }),
      boxBtnClose = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_homepage_boxbtncancel"]
      }, null, null, null, sue.apps.i18n("btn_cancel")),
      boxBtnSave = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_homepage_listbtnadd"]
      }, null, null, null, sue.apps.i18n("btn_done"));
  ...
  listEdit: function (e) {
    ...
    let boxBtn = sue.apps.domCreate("div", {
      ...
      boxBtnSave = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_homepage_listbtnedit"]
      }, null, null, {
        setName: ["id"],
        setValue: [id]
  ...
  itemInit: function (id, e) {
    ...
    let _ul = sue.apps.domCreate("ul", null, null, null, {
      setName: ["idgp"],
      setValue: [id - 1]
    });
    _dom.textContent = "";
    ...
    for (var i = 0; sites[id] && i < sites[id].length; i++) {
      var _li = sue.apps.domCreate("li", {
        ...
        setName: ["url", "id"],
        setValue: [sites[id][i].url, i]
      });
      var _div = sue.apps.domCreate("div", {
        setName: ["className"],
        setValue: ["su_homepage_item"]
      }, null, null, {
        setName: ["url", "id"],
        setValue: [sites[id][i].url, i]
      });
  ...
  itemInitEditmode: function (e) {
    ...
    if (sue.apps.homepage.cons.editMode) {
      _dom.appendChild(sue.apps.domCreate("div", {
        setName: ["className"],
        setValue: ["su_homepage_itemadd"]
      }, null, "text-align:center", null, "+"));
    } else {
    ...
    if (sue.apps.homepage.cons.editMode) {
      sue.apps.homepage.cons.sortDomItem = Sortable.create(_dom, {
        ...
        onEnd: function (evt) {
          let _listId = parseInt(sue.apps.homepage.cons.curListId);
          let arr = sue.apps.homepage.config.sites[_listId - 1];
          for (var ii in arr) {
            if (ii == evt.oldIndex) {
              arr.splice(evt.newIndex, 0, arr.splice(evt.oldIndex, 1)[0]);
              break;
  ...
  itemEdit: function (e) {
    ...
    let boxMain = sue.apps.domCreate("div", {
      ...
      boxTitleLabel = sue.apps.domCreate("label", {
        setName: ["className"],
        setValue: ["su_homepage_addboxlabel"]
      }, null, null, null, sue.apps.i18n("homepage_sitetitle")),
      boxTitle = sue.apps.domCreate("input", {
        setName: ["className", "type", "value"],
        setValue: ["su_homepage_boxtitle", "text", sue.apps.homepage.config.sites[idgp][id].title]
      }),
      boxUrlLabel = sue.apps.domCreate("label", {
        setName: ["className"],
        setValue: ["su_homepage_addboxlabel"]
      }, null, null, null, sue.apps.i18n("homepage_siteurl")),
    ...
    let boxBtn = sue.apps.domCreate("div", {
      ...
      boxBtnSave = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_homepage_boxbtnedit"]
      }, null, null, {
        setName: ["idgp", "id"],
        setValue: [idgp, id]
      }, sue.apps.i18n("btn_done"));
  ...
  itemNew: function (e) {
    ...
    let boxBtn = sue.apps.domCreate("div", {
      ...
      boxBtnSave = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_homepage_boxbtnnew"]
      }, null, null, null, sue.apps.i18n("btn_done"));
    boxBtn.appendChild(boxBtnClose);
    boxBtn.appendChild(boxBtnSave);
    domBox.appendChild(boxBtn);
  ...
  itemCTM: function () {
    ...
    let boxMain = sue.apps.domCreate("div", {
      ...
      boxGroupLabel = sue.apps.domCreate("label", {
        setName: ["className"],
        setValue: ["su_homepage_addboxlabel"]
      }, null, null, null, sue.apps.i18n("homepage_grouptitle")),
    ...
    let boxBtn = sue.apps.domCreate("div", {
      ...
      boxBtnSave = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_homepage_ctmbtnsave"]
      }, null, null, {
        setName: ["idgp", "id"],
        setValue: ["idgp", "id"]
      }, sue.apps.i18n("btn_done"));
