  ...
  initUI: function () {
    ...
    let _textDes = sue.apps.domCreate("div", null, null, "text-align:left;", null, sue.apps.i18n("autoreload_interval")),
      _text = sue.apps.domCreate("input", {
        setName: ["id", "type", "min", "value"],
        setValue: ["su_autoreload_interval", "number", "1", "10"]
      }),
      ...
      _labelCache = sue.apps.domCreate("label", {
        setName: ["for"],
        setValue: ["su_autoreload_cache"]
      }, null, null, null, sue.apps.i18n("autoreload_cache")),
      ...
      _labelIcon = sue.apps.domCreate("label", {
        setName: ["for"],
        setValue: ["su_autoreload_icon"]
      }, null, null, null, sue.apps.i18n("autoreload_icon")),

      _btn = sue.apps.domCreate("div", {setName: ["id"], setValue: ["su_autoreload_btnbox"]}),
      _btnStart = sue.apps.domCreate("button", {
        setName: ["className", "id"],
        setValue: ["btn", "start"]
      }, null, null, null, sue.apps.i18n("btn_start")),
      _btnStop = sue.apps.domCreate("button", {
        setName: ["className", "id"],
        setValue: ["btn", "stop"]
      }, null, null, null, sue.apps.i18n("btn_stop")),

      _des = sue.apps.domCreate("div", {
        setName: ["id"],
        setValue: ["su_autoreload_desbox"]
      }, null, null, null, "*" + "Click the button 'STOP' or close current tab to disable the auto reload"),
      ...
      case"click":
        if (e.target.classList.contains("btn")) {
          chrome.runtime.sendMessage({
            ...
            value: {
              type: e.target.id,
              interval: parseInt(sue.apps.autoreload.dom.querySelector("#su_autoreload_interval").value),
              iconCountdown: sue.apps.autoreload.dom.querySelector("#su_autoreload_icon").checked,
              bypassCache: sue.apps.autoreload.dom.querySelector("#su_autoreload_cache").checked
            }
          });
