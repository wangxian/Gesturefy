...
sue.apps.savepdf = {
  ...
  initUI: function () {
    ...
    let _optBox = sue.apps.domCreate("div", {
        setName: ["className"],
        setValue: ["su_options"]
      }),
      _optDes = sue.apps.domCreate("div", null, null, null, null, sue.apps.i18n("savepdf_resetDes")),
      _optBtnBox = sue.apps.domCreate("div", {
        setName: ["className"],
        setValue: ["options_btnbox"]
      }),
      _optBtn = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["options_btn_reset"]
      }, null, null, null, sue.apps.i18n("btn_reset"));
  ...
  initOptions: function (pdfConf) {
    ...
    let _btnBox = sue.apps.domCreate("div", {
        setName: ["className"],
        setValue: ["btnbox"]
      }),
      _btn = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_savepdf_btn"]
      }, null, null, null, "Generate PDF");
    _btnBox.appendChild(_btn);
    theAppBox.appendChild(_btnBox);

    let _spanOri = sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_savepdf_span"]
      }, null, null, null, sue.apps.i18n("savepdf_" + "orientation")),
      _selectOri = sue.apps.domCreate("select", {
        setName: ["className", "name"],
        setValue: ["pdfele", "savepdf_orientation"]
      });
    let _optionOri_0 = sue.apps.domCreate("option", {
        setName: ["value"],
        setValue: ["0"]
      }, null, null, null, sue.apps.i18n("savepdf_" + "portrait")),
      _optionOri_1 = sue.apps.domCreate("option", {
        setName: ["value"],
        setValue: ["1"]
      }, null, null, null, sue.apps.i18n("savepdf_" + "landscape"))
    ...
    let _spanPap = sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_savepdf_span"]
      }, null, null, null, sue.apps.i18n("savepdf_" + "paperSizeUnit")),
      _selectPap = sue.apps.domCreate("select", {
        setName: ["className", "name"],
        setValue: ["pdfele", "savepdf_paperSizeUnit"]
      });
    let _optionPap_0 = sue.apps.domCreate("option", {
        setName: ["value"],
        setValue: ["0"]
      }, null, null, null, sue.apps.i18n("savepdf_" + "inches")),
      _optionPap_1 = sue.apps.domCreate("option", {
        setName: ["value"],
        setValue: ["1"]
      }, null, null, null, sue.apps.i18n("savepdf_" + "millimeters"))
    ...
    for (var i = 0; i < _arrayCheck.length; i++) {
      var _check = sue.apps.domCreate("input", {
        setName: ["className", "id", "type", "checked"],
        setValue: ["pdfele su_savepdf_text", "savepdf_" + _arrayCheck[i], "checkbox", (pdfConf[_arrayCheck[i]] ? " checked" : "")]
      });
      var _label = sue.apps.domCreate("label", {
        setName: ["className", "for"],
        setValue: ["su_savepdf_label", "savepdf_" + _arrayCheck[i]]
      }, null, null, null, sue.apps.i18n("savepdf_" + _arrayCheck[i]));
    ...
    for (var i = 0; i < _arrayText.length; i++) {
      var _spanText = sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_savepdf_span"]
      }, null, null, null, sue.apps.i18n("savepdf_" + _arrayText[i]));
      var _text = sue.apps.domCreate("input", {
        setName: ["className", "id", "type", "placeholder", "value"],
        setValue: ["pdfele su_savepdf_text", "savepdf_" + _arrayText[i], "text", sue.apps.i18n("place_string"), pdfConf[_arrayText[i]]]
      }, null, null, {
        setName: ["type"],
        setValue: ["string"]
      });
    ...
    for (var i = 0; i < _arrayText_Num.length; i++) {
      var _spanText = sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_savepdf_span"]
      }, null, null, null, sue.apps.i18n("savepdf_" + _arrayText_Num[i]));
      var _text = sue.apps.domCreate("input", {
        setName: ["className", "id", "type", "placeholder", "value"],
        setValue: ["pdfele su_savepdf_text", "savepdf_" + _arrayText_Num[i], "text", sue.apps.i18n("place_number"), pdfConf[_arrayText_Num[i]] /**/]
      }, null, null, {
        setName: ["type"],
        setValue: ["number"]
      });
  ...
  pdf: function (e) {
    let pdfData = {},
      pdfDom = sue.apps.getAPPboxEle(e),
      i = 0;
