...
sue.apps.tbkjx = {
  ...
  initUI: function () {
    let appInfo = {
      ...
      menu: [{
      ...
      },
        {
          src: "/image/info.svg",
          title: "app_tip_info",
          className: "menu_item menu_item_help"
        }
      ],
      options: [{
        type: "range",
    ...
    let theAppBox = sue.apps.domCreate("div", {
      setName: ["className"],
      setValue: ["su_tbkjx_box"]
    });
    dom.querySelector(".su_main").appendChild(theAppBox);

    let boxContent = sue.apps.domCreate("div", {
      setName: ["className"],
      setValue: ["su_tbkjx_boxcontent"]
    });
    boxContent.appendChild(sue.apps.domCreate("img", {
      setName: ["src"],
      setValue: [chrome.runtime.getURL("/image/loading.gif")]
    }, null, "margin: 100px 140px;"));

    let boxList = sue.apps.domCreate("div", {
        setName: ["className"],
        setValue: ["su_tbkjx_boxlist"]
      }),
      listHead = sue.apps.domCreate("div", {
        setName: ["className"],
        setValue: ["su_tbkjx_listhead"]
      }),
      listJing = sue.apps.domCreate("div", {
        setName: ["className"],
        setValue: ["su_tbkjx_listjing"]
      }),
      listBottom = sue.apps.domCreate("div", {
        setName: ["className"],
        setValue: ["su_tbkjx_listbottom"]
      });

    let boxSearch = sue.apps.domCreate("div", {
      setName: ["className"],
      setValue: ["su_tbkjx_boxsearch"]
    });
    boxSearch.appendChild(sue.apps.domCreate("input", {
      setName: ["id", "placeholder", "type"],
      setValue: ["su_tbkjx_searchkey", "键入关键字搜索", "text"]
    }, null, null, null));
    boxSearch.appendChild(sue.apps.domCreate("button", {
      setName: ["id"],
      setValue: ["su_tbkjx_search"]
    }, null, null, null, "搜索"));

    let headSort = sue.apps.domCreate("div", {
      setName: ["className"],
      setValue: ["su_tbkjx_sort"]
    });
    let _sortReset = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_tbkjx_sortbtn su_tbkjx_sortreset"]
      }, null, null, null, "默认排序"),
      _sortUp = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_tbkjx_sortbtn su_tbkjx_sortup"]
      }, null, "margin:0 5px;", null, "价格由低到高"),
      _sortDn = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_tbkjx_sortbtn su_tbkjx_sortdn"]
      }, null, null, null, "价格由高到低"),
      _sortCup = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_tbkjx_sortbtn su_tbkjx_sortcup"]
      }, null, null, null, "优惠券额由低到高"),
      _sortCdn = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_tbkjx_sortbtn su_tbkjx_sortcdn"]
      }, null, "margin:2px 4px;", null, "优惠券额由高到低");
    ...
    let headPlatform = sue.apps.domCreate("div", {
      setName: ["className"],
      setValue: ["su_tbkjx_platform"]
    });
    let _platformAll = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_tbkjx_platformbtn su_tbkjx_platformall"]
      }, null, null, {
        setName: ["platform"],
        setValue: ["0"]
      }, "所有平台"),
      _platformTaobao = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_tbkjx_platformbtn su_tbkjx_platformtaobao"]
      }, null, "margin:0 5px;", {
        setName: ["platform"],
        setValue: ["1"]
      }, "淘宝"),
      _platformTianmao = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_tbkjx_platformbtn su_tbkjx_platformtianmao"]
      }, null, "margin:0 5px;", {
        setName: ["platform"],
        setValue: ["2"]
      }, "天猫");
    ...
    let headExtent = sue.apps.domCreate("div", {
      setName: ["className"],
      setValue: ["su_tbkjx_extent"]
    });
    let _extentSpan = sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_tbkjx_extentspan"]
      }, null, null, null, "价格范围："),
      _extentFrom = sue.apps.domCreate("input", {
        setName: ["className", "id", "placeholder", "type"],
        setValue: ["su_tbkjx_extenttext", "su_tbkjx_extentfrom", "最低价", "text"]
      }, null, null, null),
      _extentDash = sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_tbkjx_extenttext"]
      }, null, "font-size:10px;", null, "~"),
      _extentTo = sue.apps.domCreate("input", {
        setName: ["className", "id", "placeholder", "type"],
        setValue: ["su_tbkjx_extenttext", "su_tbkjx_extento", "最高价", "text"]
      }, null, null, null),
      _extentBtn = sue.apps.domCreate("button", {
        setName: ["className", "id"],
        setValue: ["su_tbkjx_extentbtn", "su_tbkjx_extentbtn"]
      }, null, null, null, "确定");
    ...
    let _bottomPre = sue.apps.domCreate("button", {
        setName: ["id", "className", "title"],
        setValue: ["su_tbkjx_btnpre", "su_tbkjx_page", "上一页"]
      }, null, null, null, "<"),
      _bottomHome = sue.apps.domCreate("button", {
        setName: ["id", "className", "title"],
        setValue: ["su_tbkjx_btnhome", "su_tbkjx_page", "第一页"]
      }, null, "width:40px;margin:0 4px;", {
        setName: ["page"],
        setValue: ["0"]
      }, "□"),
      _bottomNext = sue.apps.domCreate("button", {
        setName: ["id", "className", "title"],
        setValue: ["su_tbkjx_btnnext", "su_tbkjx_page", "下一页"]
      }, null, null, null, ">"),
      _bottomDes = sue.apps.domCreate("div", {
        setName: ["className"],
        setValue: ["su_tbkjx_des"]
      }, null, null, null, "只买需要的，不买便宜的(*^_^*)");
    ...
    let _infoBox = sue.apps.domCreate("div", {
        setName: ["className"],
        setValue: ["su_options_help"]
      }),
    ...
    let _a = sue.apps.domCreate("a", {
      setName: ["href", "target"],
      setValue: ["https://quan.zimoapps.com", "_blank"]
    }, null, null, null, "quan.zimoapps.com");
    _li.appendChild(_a);
  ...
  itemInit: function (data) {
    ...
    let _img = sue.apps.domCreate("div", {
        setName: ["className", "title"],
        setValue: ["su_tbkjx_img", "点击图片显示领券地址的二维码。\n通过手机淘宝扫码在手机上领券购买！"]
      }, null, "background-image:url(" + data[1] + ");background-size:contain"),

      _name = sue.apps.domCreate("div", {
        setName: ["className", "title"],
        setValue: ["su_tbkjx_name", DOMPurify.sanitize(data[0])]
      }, null, null, null, DOMPurify.sanitize(data[0])),

      _spanPrice = sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_tbkjx_spanprice su_tbkjx_open"]
      }, null, null, {
        setName: ["link"],
        setValue: [DOMPurify.sanitize(data[3])]
      }, "券后价"),
      _price = sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_tbkjx_price su_tbkjx_open"]
      }, null, null, {
        setName: ["link"],
        setValue: [DOMPurify.sanitize(data[3])]
      }, "￥" + DOMPurify.sanitize(data[2])),
      _buy = sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_tbkjx_buy su_tbkjx_open"]
      }, null, null, {
        setName: ["link"],
        setValue: [DOMPurify.sanitize(data[3])]
      }, "前往领券(￥" + DOMPurify.sanitize(data[4]) + ")"),

      _btnBox = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_tbkjx_btnbox su_tbkjx_open"]
      }, null, null, {
        setName: ["link"],
        setValue: [DOMPurify.sanitize(data[3])]
      });
    ...
    let _domQr = sue.apps.domCreate("div", {
      setName: ["className"],
      setValue: ["su_tbkjx_qr"]
    }, null, "display:none;");
  ...
  initList: function (data, page) {
    ...
    for (var i = 0; i < data.length; i++) {
      _listUL.appendChild(sue.apps.domCreate("li", {
        setName: ["className", "title"],
        setValue: ["su_tbkjx_listitem", DOMPurify.sanitize(data[i][0])]
      }, null, null, {
        setName: ["id"],
        setValue: [i + _page * _listLength]
      }, DOMPurify.sanitize(data[i][0])));
    }
  ...
  setSortBtn: function () {
    ...
    if (!sue.apps.tbkjx.cons.curSort) {
      sue.apps.tbkjx.cons.curSort = "reset"
    }
