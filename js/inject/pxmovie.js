...
sue.apps.pxmovie = {
  ...
  initUI: function () {
    ...
    theAppBox.appendChild(sue.apps.domCreate("img", {
      setName: ["className", "src"],
      setValue: ["loading", chrome.runtime.getURL("/image/loading.gif")]
    }));
  ...
  list: function (message) {
    ...
    for (var i = 0; i < value.length; i++) {
      var _li = sue.apps.domCreate("li", {setName: ["className"], setValue: ["item"]}, null, null, {
        setName: ["url"],
        setValue: [value[i][3]]
      }, "[" + value[i][0] + "]" + value[i][2]);
      _ul.appendChild(_li);
  ...
  data: function (message) {
    ...
    let _data = dom.querySelector(".data"),
      ...
      _back = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["back"]
      }, null, "display: inline-block;", null, sue.apps.i18n("btn_back"));
