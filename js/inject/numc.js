...
sue.apps[appName] = {
  ...
  initUI: function () {
    ...
    let _spanFrom = sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_numc_span"]
      }, null, null, null, sue.apps.i18n("app_numc_from")),
      ...
      _spanTo = sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_numc_span"]
      }, null, null, null, sue.apps.i18n("app_numc_to")),
