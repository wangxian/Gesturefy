...
sue.apps.random = {
  ...
  initUI: function () {
    ...
    let _node = {
      ...
      boundSpan: sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_random_span"]
      }, null, null, null, sue.apps.i18n("app_random_bound")),
      ...
      numSpan: sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_random_span"]
      }, null, null, null, sue.apps.i18n("app_random_num")),
