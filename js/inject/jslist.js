...
sue.apps.jslist = {
    ...
    let appInfo = {
      ...
      menu: [{
      ...
      },
        {
          src: "/image/edit.svg",
          title: "editmode",
          className: "menu_item menu_item_edit"
        }
      ],
      options: [{
        type: "checkbox",
      ...
      for (var ii = 0; ii < _jsAll.length; ii++) {
        if (_enabled[i] == ii.toString()) {
          ...
          var _div = sue.apps.domCreate("div", {
            setName: ["className"],
            setValue: ["su_jslist_li su_jslist_item"]
          }, null, null, {
            setName: ["id"],
            setValue: [ii]
          }, _jsAll[ii].name);
  ...
  editModeInit: function (e) {
    ...
    let _uldisabled = sue.apps.domCreate("ul", {
      setName: ["className"],
      setValue: ["su_jslist_uldisabled"]
    });
    let _jsAll = sue.apps.jslist.js,
      _enabled = sue.apps.jslist.config.enabled;
