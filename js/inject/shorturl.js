sue.apps.shorturl = {
  ...
  initUI: function () {
    ...
    let domInfo = sue.apps.domCreate("div", {
      setName: ["className"],
      setValue: ["su_shorturl_info"]
    }, null, null, null, sue.apps.i18n("app_shorturl_wait"));
    ...
    let domSourceText = sue.apps.domCreate("textarea", {
        setName: ["className", "type", "value", "disabled"],
        setValue: ["su_shorturl_textsource", "text", window.location.href, "disabled"]
      }, null, null, null),
      domKey = sue.apps.domCreate("input", {
        setName: ["className", "type", "placeholder", "title"],
        setValue: ["su_shorturl_textkey", "text", sue.apps.i18n("app_shorturl_keyholder"), sue.apps.i18n("app_shorturl_keyholder")]
      }, null, null, null),
      domBtn = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_shorturl_btn"]
      }, null, null, null, sue.apps.i18n("app_shorturl_btn")),
      domShortText = sue.apps.domCreate("input", {
        setName: ["className", "type", "disabled"],
        setValue: ["su_shorturl_textshort", "text", "disabled"]
      }, null, null, null, null);

    let labelSource = sue.apps.domCreate("label", {
        setName: ["className"],
        setValue: ["su_shorturl_labelsource"]
      }, null, null, null, sue.apps.i18n("app_shorturl_source")),
      labelkey = sue.apps.domCreate("label", {
        setName: ["className"],
        setValue: ["su_shorturl_labelkey"]
      }, null, "clear:both;", null, sue.apps.i18n("app_shorturl_key")),
      labelshort = sue.apps.domCreate("label", {
        setName: ["className"],
        setValue: ["su_shorturl_labelshort"]
      }, null, "clear:both;", null, sue.apps.i18n("app_shorturl_short"));
  ...
  getURL: function (e) {
    ...
    chrome.runtime.sendMessage({
      ...
      app: "shorturl",
      action: "getURL",
      value: {key: sue.apps.getAPPboxEle(e).querySelector(".su_shorturl_textkey").value}
    });
  },
  error: function (err) {
