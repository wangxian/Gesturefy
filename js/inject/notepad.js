...
sue.apps.notepad = {
  ...
  initUI: function () {
    ...
    _boxBottom.appendChild(sue.apps.domCreate("button", {setName: ["className"], setValue: ["su_notepad_btnadd"]}, null, null, {
      setName: ["action"],
      setValue: ["add"]
    }, sue.apps.i18n("btn_new")));
    _boxBottom.appendChild(sue.apps.domCreate("button", {
      setName: ["className", "id"],
      setValue: ["su_notepad_btn su_notepad_btnsave", "su_notepad_btnsave"]
    }, null, null, {setName: ["action", "id"], setValue: ["notepad-contentsave", 0]}, sue.apps.i18n("btn_save")));
    _boxBottom.appendChild(sue.apps.domCreate("div", {
      setName: ["className"],
      setValue: ["su_notepad_des"]
    }, null, null, null, sue.apps.i18n("des_notepad_bottom")));
    ...
    let boxLock = sue.apps.domCreate("div", {setName: ["className"], setValue: ["su_notepad_lock"]}),
      lockCheck = sue.apps.domCreate("input", {
        setName: ["className", "type", "id"],
        setValue: ["su_notepad_locksw", "checkbox", "su_notepad_locksw" + _time]
      }),
      lockLabel = sue.apps.domCreate("label", {
        setName: ["className", "for"],
        setValue: ["su_notepas_lockswlabel", "su_notepad_locksw" + _time]
      }, null, null, null, "Protect your notes with password."),
  ...
  saveConf: function (e) {
    ...
    chrome.runtime.sendMessage({
      type: "appsAction", app: "notepad", action: "set", value: {
        method: "put",
        data: {
          id: 0,
          last: 0,
  ...
  itemSwitch: function (e, autosave) {
    ...
    if (_autoSave) {
      sue.apps.notepad.contentSave(sue.apps.getAPPboxEle(e).querySelector(".su_notepad_btnsave"));
    }
    let ele = e.target || e;
  ...
  itemDel: function (e) {
    ...
    if (sue.apps.notepad.config.n_notepad_delconfirm) {
      if (!window.confirm(sue.apps.i18n("notepad_delconfirm"))) {
        return false;
      }
    }
  ...
  listInit: function () {
    ...
    for (var i = 0; i < data.length; i++) {
      var _li = sue.apps.domCreate("li", {setName: ["className"], setValue: ["su_notepad_li"]}, null, null, {
          setName: ["action", "id"],
          setValue: ["notepad-switch", i]
        }),
        _div = sue.apps.domCreate("div", {
          setName: ["className", "title"],
          setValue: ["su_notepad_listitem", data[i].title]
        }, null, null, {setName: ["action", "id"], setValue: ["notepad-switch", i]});
      _li.appendChild(_div);
      _div.appendChild(sue.apps.domCreate("span", {setName: ["className"], setValue: ["su_notepad_lispan"]}, null, null, {
        setName: ["action", "id"],
        setValue: ["notepad-switch", i]
      }, data[i].title));
      _div.appendChild(sue.apps.domCreate("input", {
        setName: ["className", "type", "value"],
        setValue: ["su_notepad_litext", "text", data[i].title]
      }, null, null, {setName: ["id"], setValue: [i]}));
      _div.appendChild(sue.apps.domCreate("img", {
        setName: ["className", "src", "title"],
        setValue: ["su_notepad_liedit", chrome.runtime.getURL("image/edit.svg"), sue.apps.i18n("tip_edit")]
      }, "display:inline-block;", null, {setName: ["id", "action"], setValue: [i, "notepad-edit"]}));
      _div.appendChild(sue.apps.domCreate("img", {
        setName: ["className", "src", "title"],
        setValue: ["su_notepad_lidel", chrome.runtime.getURL("image/delete.svg"), sue.apps.i18n("tip_del")]
      }, "display:inline-block;", null, {setName: ["id", "action"], setValue: [i, "notepad-del"]}));
      _ul.appendChild(_li);
    }
  ...
  showLock: function (e) {
    ...
    let _time = new Date().getTime();
    let lockCheck = sue.apps.domCreate("input", {
        setName: ["className", "type", "id"],
        setValue: ["su_notepad_locksw", "checkbox", "su_notepad_locksw" + _time]
      }),
      lockLabel = sue.apps.domCreate("label", {
    ...
    let spanenablePw = sue.apps.domCreate("span", {setName: ["className"], setValue: ["su_notepad_lockspan"]}, null, null, null, "input password:"),
      ...
      spanenablePwre = sue.apps.domCreate("span", {
        setName: ["className"],
        setValue: ["su_notepad_lockspan"]
      }, null, null, null, "confirm password:"),
      enablePwre = sue.apps.domCreate("input", {setName: ["className", "type"], setValue: ["su_notepad_lockenable_pwre", "password"]}),
      enableBtn = sue.apps.domCreate("button", null, null, null, {
        setName: ["action"],
        setValue: ["notepad-lockenable"]
      ...
      disableBtn = sue.apps.domCreate("button", null, null, null, {
        setName: ["action"],
        setValue: ["notepad-lockdisable"]
      }, sue.apps.i18n("btn_done"));
