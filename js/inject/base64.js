...
sue.apps.base64 = {
  ...
  initUI: function () {
    ...
    let _str = sue.apps.domCreate("div", {setName: ["className"], setValue: ["base_str"]}),
      ...
      _btnEncode = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["base_btn_encode"]
      }, null, null, null, sue.apps.i18n("btn_encode")),
      _btnDecode = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["base_btn_decode"]
      }, null, null, null, sue.apps.i18n("btn_decode"));
