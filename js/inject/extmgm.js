...
sue.apps.extmgm = {
  ...
  firstItem: function (dom) {
    ...
    for (var i = 0; i < _config.length; i++) {
      ...
      var _div = sue.apps.domCreate("div", {setName: ["className"], setValue: ["su_extmgm_itemfirst"]}, null, null, {
        setName: ["id"],
        setValue: [i]
      }, _config[i].gpname);
    ...
    chrome.runtime.sendMessage({
      ...
      for (var i = 0; i < _exts.length; i++) {
        ...
        if (sue.apps.extmgm.config.exts[id].id.contains(_exts[i].id)) {
          var _li = sue.apps.domCreate("li", {setName: ["className"], setValue: ["su_extmgm_itemli"]}, null, null, {
            setName: ["id"],
            setValue: [_exts[i].id]
          });
          var _div = sue.apps.domCreate("div", {setName: ["className"], setValue: ["su_extmgm_item"]}, null, null, {
            setName: ["id"],
            setValue: [_exts[i].id]
          });
          var _img = sue.apps.domCreate("img", {
            setName: ["src"],
            setValue: [_exts[i].iconBase64 ? _exts[i].iconBase64 : chrome.runtime.getURL("image/extension.svg")]
          });
          var _span = sue.apps.domCreate("span", {
            setName: ["className"],
            setValue: ["su_extmgm_itemname"]
          }, null, null, null, _exts[i].name);
          var _spanAction = sue.apps.domCreate("span", {setName: ["className"], setValue: ["su_extmgm_itemaction"]});
          var _actionDis = sue.apps.domCreate("img", {
            setName: ["src", "title", "className"],
            setValue: [chrome.runtime.getURL("image/disable.svg"), sue.apps.i18n("extmgm_tipdisable"), "su_extmgm_itemdisable"]
          }, null, null, {setName: ["id", "type"], setValue: [_exts[i].id, "item"]});
          var _actionOpt = sue.apps.domCreate("img", {
            setName: ["src", "title", "className"],
            setValue: [chrome.runtime.getURL("image/options.svg"), sue.apps.i18n("extmgm_tipoption"), "su_extmgm_itemopturl"]
          }, null, null, {setName: ["url"], setValue: [_exts[i].optionsUrl]});
          var _actionUninstall = sue.apps.domCreate("img", {
            setName: ["src", "title", "className"],
            setValue: [chrome.runtime.getURL("image/uninstall.svg"), sue.apps.i18n("extmgm_tipuninstall"), "su_extmgm_itemuninstall"]
          }, null, null, {setName: ["id"], setValue: [_exts[i].id]});
          ...
          if (sue.apps.extmgm.cons.editMode) {
            ...
            var _actionDis = sue.apps.domCreate("img", {
              setName: ["src", "title", "className"],
              setValue: [chrome.runtime.getURL("image/enable.svg"), sue.apps.i18n("extmgm_tipenable"), "su_extmgm_itemenable"]
            }, null, null, {setName: ["id", "type"], setValue: [_exts[i].id, "item"]});
  ...
  moreInit: function (dom) {
    ...
    for (var i = 0; i < _array.length; i++) {
      var _li = sue.apps.domCreate("li", {setName: ["className"], setValue: ["su_extmgm_moreli"]}, null, null, {setName: ["id"], setValue: [i]}),
        _div = sue.apps.domCreate("div", {setName: ["className"], setValue: ["su_extmgm_moreitem"]}, null, null, {
          setName: ["type", "id"],
          setValue: [_arrayType[i], [i]]
        }, _array[i]);
      _li.appendChild(_div);
      _ul.appendChild(_li);
    }
  ...
  groupInit: function (dom, id) {
    ...
    for (var i = 0; i < _extgroups.length; i++) {
      var _li = sue.apps.domCreate("li", {setName: ["className"], setValue: ["su_extmgm_groupli"]}, null, null, {setName: ["id"], setValue: [i]}),
        _div = sue.apps.domCreate("div", {setName: ["className"], setValue: ["su_extmgm_groupitem"]}, null, null, {
          setName: ["id"],
          setValue: [i]
        }, _extgroups[i].gpname);
      if (sue.apps.extmgm.cons.editMode) {
        ...
        // _div.appendChild(_span);
        var _imgdel = sue.apps.domCreate("img", {
          setName: ["className", "src", "title"],
          setValue: ["su_extmgm_groupdel", chrome.runtime.getURL("image/delete.svg"), sue.apps.i18n("tip_del")]
        }, "display:inline-block;", null, {setName: ["id"], setValue: [i]});
        var _imgedit = sue.apps.domCreate("img", {
          setName: ["className", "src", "title"],
          setValue: ["su_extmgm_groupedit", chrome.runtime.getURL("image/edit.svg"), sue.apps.i18n("tip_edit")]
        }, "display:inline-block;", null, {setName: ["id"], setValue: [i]});
      ...
      for (var i = 0; i < sue.apps.extmgm.cons.extLast.length; i++) {
        for (var ii = 0; ii < _exts.length; ii++) {
          if (sue.apps.extmgm.cons.extLast[i] == _exts[ii].id) {
            ...
            var _img = sue.apps.domCreate("img", {
              setName: ["src"],
              setValue: [_exts[ii].iconBase64 ? _exts[ii].iconBase64 : chrome.runtime.getURL("image/extension.svg")]
            });
            var _span = sue.apps.domCreate("span", {
              setName: ["className"],
              setValue: ["su_extmgm_itemname"]
            }, null, null, null, _exts[ii].name);
            var _spanAction = sue.apps.domCreate("span", {setName: ["className"], setValue: ["su_extmgm_itemaction"]});
            var _actionOpt = sue.apps.domCreate("img", {
              setName: ["src", "title", "className"],
              setValue: [chrome.runtime.getURL("image/options.svg"), sue.apps.i18n("extmgm_tipoption"), "su_extmgm_itemopturl"]
            }, null, null, {setName: ["url"], setValue: [_exts[ii].optionsUrl]});
            var _actionUninstall = sue.apps.domCreate("img", {
              setName: ["src", "title", "className"],
              setValue: [chrome.runtime.getURL("image/uninstall.svg"), sue.apps.i18n("extmgm_tipuninstall"), "su_extmgm_itemuninstall"]
            }, null, null, {setName: ["id"], setValue: [_exts[ii].id]});
            _div.appendChild(_img);
            _div.appendChild(_span);
      ...
      for (var i = 0; i < _exts.length; i++) {
        if (sue.apps.extmgm.config.always.contains(_exts[i].id)) {
          ...
          var _actionDis = sue.apps.domCreate("img", {
            setName: ["src", "title", "className"],
            setValue: [chrome.runtime.getURL("image/disable.svg"), sue.apps.i18n("extmgm_tipdisable"), "su_extmgm_itemdisable"]
          }, null, null, {setName: ["id", "type"], setValue: [_exts[i].id, "always"]});
          var _actionOpt = sue.apps.domCreate("img", {
            setName: ["src", "title", "className"],
            setValue: [chrome.runtime.getURL("image/options.svg"), sue.apps.i18n("extmgm_tipoption"), "su_extmgm_itemopturl"]
          }, null, null, {setName: ["url"], setValue: [_exts[i].optionsUrl]});
  ...
  editModeGroup: function (e) {
    ...
    if (sue.apps.extmgm.cons.editMode) {
      if (!_domAddbtn) {
        let _listAddBtn = sue.apps.domCreate("div", {
          setName: ["className"],
          setValue: ["su_extmgm_groupaddbtn"]
        }, null, "background:url(" + chrome.runtime.getURL("image/add.svg") + ") no-repeat 2px 5px #e7e9fd;", null, sue.apps.i18n("extmgm_newgroup"));
