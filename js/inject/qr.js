...
sue.apps.qr = {
  ...
  initUI: function () {
    ...
    // url
    let _domUrl = sue.apps.domCreate("input", {
        setName: ["className", "id", "name", "type"],
        setValue: ["qr_type_url", "qr_type_url_" + _time, "qr_type_" + _time, "radio"]
      },),
      _labelUrl = sue.apps.domCreate("label", {
        setName: ["htmlFor"],
        setValue: ["qr_type_url_" + _time]
      }, null, null, null, sue.apps.i18n("app_qr_url")),
      _brUrl = sue.apps.domCreate("br");
    _eleBox.appendChild(_domUrl);
    _eleBox.appendChild(_labelUrl);
    _eleBox.appendChild(_brUrl);
    // select text
    let _domSeltxt = sue.apps.domCreate("input", {
        setName: ["className", "id", "name", "type"],
        setValue: ["qr_type_seltxt", "qr_type_seltxt_" + _time, "qr_type_" + _time, "radio"]
      }),
      _labelSeltxt = sue.apps.domCreate("label", {
        setName: ["htmlFor"],
        setValue: ["qr_type_seltxt_" + _time]
      }, null, null, null, sue.apps.i18n("app_qr_seltxt")),
    ...
    // select link
    let _domSellnk = sue.apps.domCreate("input", {
        setName: ["className", "id", "name", "type"],
        setValue: ["qr_type_sellnk", "qr_type_sellnk_" + _time, "qr_type_" + _time, "radio"]
      }),
      _labelSellnk = sue.apps.domCreate("label", {
        setName: ["htmlFor"],
        setValue: ["qr_type_sellnk_" + _time]
      }, null, null, null, sue.apps.i18n("app_qr_sellnk")),
    ...
    // title
    let _domTitle = sue.apps.domCreate("input", {
        setName: ["className", "id", "name", "type"],
        setValue: ["qr_type_title", "qr_type_title_" + _time, "qr_type_" + _time, "radio"]
      }),
      _labelTitle = sue.apps.domCreate("label", {
        setName: ["htmlFor"],
        setValue: ["qr_type_title_" + _time]
      }, null, null, null, sue.apps.i18n("app_qr_title")),
      _brTitle = sue.apps.domCreate("br");
    _eleBox.appendChild(_domTitle);
    _eleBox.appendChild(_labelTitle);
    _eleBox.appendChild(_brTitle);
    // customer
    let _domCustomer = sue.apps.domCreate("input", {
        setName: ["className", "id", "name", "type"],
        setValue: ["qr_type_customer", "qr_type_customer_" + _time, "qr_type_" + _time, "radio"]
      }),
      _labelCustomer = sue.apps.domCreate("label", {
        setName: ["htmlFor"],
        setValue: ["qr_type_customer_" + _time]
      }, null, null, null, sue.apps.i18n("app_qr_customer")),
  ...
  handleEvent: function (e) {
    switch (e.type) {
      case"click":
        if (e.target.classList.contains("qr_btn")) {
          sue.apps.qr.code(e);
        }
        break;
      case"change":
        console.log(e);
        if (e.target.name.indexOf("qr_type") != 0) {
          return;
        }
