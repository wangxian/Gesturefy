...
sue.apps.magnet = {
  initUI: function () {
    ...
    let domInput = sue.apps.domCreate("textarea", {
        setName: ["className", "placeholder"],
        setValue: ["su_magenet_input", sue.apps.i18n("magnet_placeholder_input")]
      }),
      btnClear = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_magenet_btn su_magnet_clear"]
      }, null, null, null, sue.apps.i18n("btn_clear")),
      btnDone = sue.apps.domCreate("button", {
        setName: ["className"],
        setValue: ["su_magenet_btn su_magnet_done"]
